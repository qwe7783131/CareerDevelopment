...
public class VolunteerInfoServiceImpl implements VolunteerInfoService{
    ...
    @Override
    public ModelAndView toVolunteerPage(String deptId, String directId, Integer status, String curr) {
        /**
         * status最后再查
         * 如果有deptid 查出所有该dept的direct
         * 没有depteId但是有directId就要先查到该专业方向对应的学院
         * 都没有就最后查询
         */
...
//        List<Enroll> enrolls = wuEnrollMapper.selectByParam(deptId, directId, status);
        ...
        List<Enroll> enrolls = enrollMapper.selectByParam(deptId,directId,status);
    ...
    @Override
    public ModelAndView toDividePage(String deptId, String directId, String classId, String curr) {
        /**
         *
         * 如果有deptid 查出所有该dept的direct
