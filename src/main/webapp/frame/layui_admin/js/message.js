...
layui.define(["jquery"], function(i) {
		...
		a = {
			...
			show: function(i) {
				var e = this,
					a = e._message(),
					t = e.times,
					n = void 0 === (i = i || {}).skin ? "default" : i.skin,
					d = void 0 === i.msg ? "请输入一些提示信息!" : i.msg,
					m = void 0 === i.autoClose || i.autoClose,
	...
	layui.link(document.getElementById("frameBase").href +"/layui_admin/css/message.css"), i("message", a)
});